...
author_net <- visNetwork(nodes_df, edges_df, height = "1200px", width = "1600px") %>%
...
webshot2::webshot(
  url   = "figures/author_network.html",
  file  = "figures/author_network_static.png",
  vwidth  = 1600,
  vheight = 1200, 
  selector = ".vis-network", # cropping to only the network
  zoom = 3 
)
```
